  ...
  const handleSend = async (text?: string) => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          systemInstruction: "Bạn là trợ lý tài chính cho sinh viên. Trả lời bằng tiếng Việt, ngắn gọn, dễ hiểu, thân thiện. Tập trung vào các lời khuyên về tiết kiệm, đầu tư chứng khoán mô phỏng và quản lý tài chính cá nhân cho người trẻ.",
        }
      });
