...
export const ICONS = {
  ...
  Support: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 10 10"/><path d="M12 2v10"/><path d="m16 8 4-4"/><path d="m16 16 4 4"/><path d="m8 16-4 4"/><path d="m8 8-4-4"/></svg>
  ),
  Faq: () => (
...
<<<<<<< HEAD:client/constants.tsx
    Minimized: () => (
=======
  Minimized: () => (
>>>>>>> 714e4f413d0b48b1fcd7c9784cdf84e8a15a8306:constants.tsx
